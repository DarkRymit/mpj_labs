...
public class Task2 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        var cordX = comm_cart.Shift(0, 1);
        neighbours_ranks[2] = cordX.rank_source;
        neighbours_ranks[3] = cordX.rank_dest;
        // Let consider dims[1] = Y, so the shift tells us our up and down neighbours
        var cordY = comm_cart.Shift(1, 1);
        neighbours_ranks[0] = cordY.rank_source;
        neighbours_ranks[1] = cordY.rank_dest;
